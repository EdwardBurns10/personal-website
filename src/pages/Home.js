          ...
          <Grid container spacing={0}>
              ...
              <Grid item xs={8} >
                  <div data-aos="fade-zoom-in"
                       ...
                       data-aos-offset="0">
                  <Paper data-aos="fade-up" elevation='0' style={{backgroundColor:'transparent',color:'#8b9e8a'}} className={classes.txt}> <Paper style={{backgroundColor:'#8b9e8a',color:'#efeadb',padding:'10px'}}>I am interested in applying engineering skills to increase the efficiency of organizations, including data analytics, information systems, security, operations and supply chain management, and organizational behaviour. In addition to core engineering courses, I have completed courses in computer programming, management engineering concepts, financial management, work design and facilities planning.</Paper>
                      <br></br><br></br>
